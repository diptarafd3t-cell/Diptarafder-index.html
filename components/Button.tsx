...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    ...
    secondary: "bg-purple-600 hover:bg-purple-700 text-white shadow-lg shadow-purple-500/30 border border-transparent focus:ring-purple-500",
    outline: "bg-transparent border-2 border-slate-600 hover:border-slate-400 text-slate-200 hover:text-white focus:ring-slate-500",
